...
export default function ApplicationsPage() {
  ...
  return (
    <Grid container rowSpacing={3}>
      <Grid size={12}><Stack direction={{ xs: 'column', sm: 'row' }} sx={{ alignItems: { sm: 'center' }, justifyContent: 'flex-end', gap: 2 }}><Button component={Link} to="/applications/new" variant="contained" startIcon={<PlusOutlined />}>Add Application</Button></Stack></Grid>
